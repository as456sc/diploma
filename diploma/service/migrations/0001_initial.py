# Generated by Django 4.1.7 on 2023-09-04 19:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_info', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='ordered_items', to='service.productinfo', verbose_name='Информация о продукте')),
                ('shop', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='order_items', to='service.shop', verbose_name='Магазин')),
            ],
            options={
